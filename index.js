...
var token = {};
var payload = {};
var gateway_sid; // todo: multiple gateway
...
var password = process.env.XIAOMI_PASSWORD|| "";
var level =  "info";
var heartbeatfreq = 1;
var dataFormat =  "parsed"
...
server.on('message', function(buffer, rinfo) {
  ...
  try {
    ...
    console.log("Received message: ", JSON.stringify(msg, null, 2));  // Output to stdout
  } catch (err) {
